...
; test to ensure player is within screen horizontal scroll bounds
;
; out: 0 if success
.proc can_scroll_horizontal
check_left:
    jsr get_first_col
    ;cmp #min_bound*2
    beq failure
...
; test to ensure player is within screen vertical scroll bounds
;
; out: 0 if success
.proc can_scroll_vertical
